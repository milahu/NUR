...
[
  ...
  (fetchpatch' {
    name = "python3Packages.gst-python: fix compilation when `doInstallCheck=false`";
    prUrl = "https://github.com/NixOS/nixpkgs/pull/451261";
    # saneCommit = "a67f93993ee1ffb5b657ae7b26e0dcb047e9df1b";
    hash = "sha256-MQv+3JBf04huqS96nO2gD8cLKJiJ8idNtpTRVgKXJjc=";
  })
  ...
  # (fetchpatch' {
  #   # XXX(2025-10-14): breaks eval, see <https://github.com/NixOS/nixpkgs/issues/452013>
  #   name = "nixos/tor: add onion service unix sockets to BindPaths";
  #   prUrl = "https://github.com/NixOS/nixpkgs/pull/440889";
  #   revert = true;
  #   hash = "sha256-edzDmkm2UwB+tlcsgXp7+Zvv1VgA7bzXj18ICpt2d9E=";
  # })

  # (fetchpatch' {
  #   name = "millipixels: 0.22.0 -> 0.23.0";
  #   prUrl = "https://github.com/NixOS/nixpkgs/pull/444783";
  #   # saneCommit = "64711ccdc6c1837c4901f5287295f319751b2995";
  # })
