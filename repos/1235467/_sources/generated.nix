...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  aichat = {
    pname = "aichat";
    version = "17fbc46e195d2630650ad2d0c60cb4d197d1d8e4";
    src = fetchFromGitHub {
      owner = "sigoden";
      repo = "aichat";
      rev = "17fbc46e195d2630650ad2d0c60cb4d197d1d8e4";
      fetchSubmodules = false;
      sha256 = "sha256-judwFwTiF45i5LWeiv7tkFw1T3sTLt4s+CvUDLFmlN0=";
    };
    date = "2025-01-10";
  };
  av1an = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "2778aff08fba59a34b404751039d7acb6bfb3bdf";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "2778aff08fba59a34b404751039d7acb6bfb3bdf";
      fetchSubmodules = true;
      sha256 = "sha256-gYlminxNivqjOur5Zp6xDOh1U3VesO7/t+fNlV1WFH8=";
    };
    date = "2025-01-11";
  };
  hyprwayland-scanner = {
  ...
  libdrm = {
    pname = "libdrm";
    version = "c7684a957aa7dc98fbf8e595256b81d7de17cef8";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/mesa/drm";
      rev = "c7684a957aa7dc98fbf8e595256b81d7de17cef8";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-CAQIfolMlv1uER5Lh/m6hEQsipgXdqZNaCFJeYIIMiU=";
    };
    date = "2025-01-09";
  };
  llamafile = {
  ...
  mieru = {
    pname = "mieru";
    version = "f43ff831d51f0796111748d5b7013b581096ac2a";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "f43ff831d51f0796111748d5b7013b581096ac2a";
      fetchSubmodules = false;
      sha256 = "sha256-xwi9T7M4FEl79kyGj+F1HX8000PFLrBfTmnEaLwnEFg=";
    };
    date = "2025-01-10";
  };
  nbfc-linux = {
  ...
  sakaya = {
    pname = "sakaya";
    version = "2b222ab82a15be7b89f8c06aa1c2778ee5cafa93";
    src = fetchFromGitHub {
      owner = "donovanglover";
      repo = "sakaya";
      rev = "2b222ab82a15be7b89f8c06aa1c2778ee5cafa93";
      fetchSubmodules = false;
      sha256 = "sha256-JwacCM/CKt2ErfkcJgySqBgu17x+DK/Nr/xEMddPrbI=";
    };
    date = "2025-01-11";
  };
  suyu = {
  ...
  sway = {
    pname = "sway";
    version = "3629a832e5b3a73ccd4e42eca79943af121866da";
    src = fetchFromGitHub {
      owner = "swaywm";
      repo = "sway";
      rev = "3629a832e5b3a73ccd4e42eca79943af121866da";
      fetchSubmodules = true;
      sha256 = "sha256-Cqe5wzhRWE3ggHk+G9QpvNn4K+zTFU3iXYVD2/bMIDA=";
    };
    date = "2025-01-11";
  };
  swgp-go = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "eb85831284b6f46301e41205c5d4e08fc5b92c27";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-itELarxPdIBx5EhDxXZht4Iw8kddaiHVHuAWtf0pGfU=";
    };
    date = "2025-01-11";
  };
}
