...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8b9e385943d1a9fd0f8c6070fa1eae507ae26145";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "8b9e385943d1a9fd0f8c6070fa1eae507ae26145";
      fetchSubmodules = true;
      sha256 = "sha256-eZPhLQ8DM8AsP+zM1KmUzxWQaiTpOUbFS1xeOyjgwvg=";
    };
    date = "2024-09-11";
  };
  hyprwayland-scanner = {
  ...
  sway = {
    pname = "sway";
    version = "d7a76d381bbe4321578bc3a95fbc82d76b67ef05";
    src = fetchFromGitHub {
      owner = "swaywm";
      repo = "sway";
      rev = "d7a76d381bbe4321578bc3a95fbc82d76b67ef05";
      fetchSubmodules = true;
      sha256 = "sha256-wFGfdDFLGuciRGQSAV0TGsU+Yq/vGq+ZlJY7Vt7DVcM=";
    };
    date = "2024-09-10";
  };
  swgp-go = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "bf0cac12a3ac68841245d0af19aafd5f43d42cb1";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "bf0cac12a3ac68841245d0af19aafd5f43d42cb1";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ecelEoTdLdJv00SwfNI4fUQrgik0T6rb3ENEVrXNiik=";
    };
    date = "2024-09-11";
  };
}
