...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "31422ae25dee33dd000798b64a80bd7fd08d2ece";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "31422ae25dee33dd000798b64a80bd7fd08d2ece";
      fetchSubmodules = true;
      sha256 = "sha256-BMSkybR8NTDACUk4swh25qHzKeEF2mN5fMVX1AtOhmc=";
    };
    date = "2024-12-21";
  };
  hyprwayland-scanner = {
  ...
  koboldcpp = {
    pname = "koboldcpp";
    version = "fd5100c382331f40130ac8d28fd1e39c16bc4d06";
    src = fetchFromGitHub {
      owner = "LostRuins";
      repo = "koboldcpp";
      rev = "fd5100c382331f40130ac8d28fd1e39c16bc4d06";
      fetchSubmodules = true;
      sha256 = "sha256-CgJzYF8FnHk0zKdysGJWLnNo/MND24AbQdjRbDtv0II=";
    };
    date = "2024-12-21";
  };
  libdrm = {
  ...
  mieru = {
    pname = "mieru";
    version = "9db17d3823ee72176ad02a3ddb171eecfc537c49";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "9db17d3823ee72176ad02a3ddb171eecfc537c49";
      fetchSubmodules = false;
      sha256 = "sha256-RtI9/KbPR1izqfN75v+eaMViBUrsgoJsXfJVMCRJ5uk=";
    };
    date = "2024-12-21";
  };
  nbfc-linux = {
  ...
  wayland-protocols = {
    ...
    version = "6bcf87d9c17a36bb56943efeb4cbb851bd3734b8";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wayland/wayland-protocols";
      rev = "6bcf87d9c17a36bb56943efeb4cbb851bd3734b8";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-SDS6UF8ko0GkjFA3R8eFROB9MiPHLGJCcVKbK5rm7LY=";
    };
    date = "2024-12-20";
  };
  waylyrics = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "c6de47d4158b95a69f678b4131d6a0f8fd9032f0";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-dRNCcJkcWpWReoSfdo27ps0YjUGAkL0EhnnrK1goCYc=";
    };
    date = "2024-12-21";
  };
}
