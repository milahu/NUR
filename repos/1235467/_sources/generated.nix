...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  candy = {
    pname = "candy";
    version = "74ea06a719055c3af368046468f322d62cb3a4c4";
    src = fetchFromGitHub {
      owner = "lanthora";
      repo = "candy";
      rev = "74ea06a719055c3af368046468f322d62cb3a4c4";
      fetchSubmodules = false;
      sha256 = "sha256-uAVPbyuFCLBdKegUwKQLfougGjS/hRM+7Yl7v/Ld06k=";
    };
    date = "2024-10-24";
  };
  hyprland = {
    pname = "hyprland";
    version = "d5689bb53935ff1adbbfc9fdf5b1f542ce39efb2";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "d5689bb53935ff1adbbfc9fdf5b1f542ce39efb2";
      fetchSubmodules = true;
      sha256 = "sha256-p6xarNvoN+tkb2KQwfvwrE7dgrCZ8GcvpukIif171VU=";
    };
    date = "2024-10-26";
  };
  hyprwayland-scanner = {
  ...
  llamafile = {
    pname = "llamafile";
    version = "5ead373a502ac686d111ea03e39dfaa9fb05b9f0";
    src = fetchFromGitHub {
      owner = "Mozilla-Ocho";
      repo = "llamafile";
      rev = "5ead373a502ac686d111ea03e39dfaa9fb05b9f0";
      fetchSubmodules = false;
      sha256 = "sha256-hAFLuZxPJGvBy5KHe6wHU/JIerPOJ13VH+XBsPAzrl0=";
    };
    date = "2024-10-25";
  };
  mieru = {
  ...
  sakaya = {
    pname = "sakaya";
    version = "f7961a0fbcae4927828783d49687eb332af250a9";
    src = fetchFromGitHub {
      owner = "donovanglover";
      repo = "sakaya";
      rev = "f7961a0fbcae4927828783d49687eb332af250a9";
      fetchSubmodules = false;
      sha256 = "sha256-cs7lHOdOwAwzokXAfhpRpcDl4hduD31Eus8vBALx47Y=";
    };
    date = "2024-10-24";
  };
  suyu = {
  ...
  sway = {
    pname = "sway";
    version = "015e357fce8250cdde03844ca81e9ae982ef4bfb";
    src = fetchFromGitHub {
      owner = "swaywm";
      repo = "sway";
      rev = "015e357fce8250cdde03844ca81e9ae982ef4bfb";
      fetchSubmodules = true;
      sha256 = "sha256-RRLx6nasm4SaUox2K8O7EFE1e43EFCdZ9Itanm0DSn4=";
    };
    date = "2024-10-25";
  };
  swgp-go = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "6006023a377868187f73d2e0922bbe952072684f";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "6006023a377868187f73d2e0922bbe952072684f";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-MhxZph4XUEsakErwCQ5QuarwxTfTXyksqcNmienS7H0=";
    };
    date = "2024-10-25";
  };
}
