...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  aichat = {
    pname = "aichat";
    version = "bad5084e148ae1a392e3ac1ea96a6217f7f02844";
    src = fetchFromGitHub {
      owner = "sigoden";
      repo = "aichat";
      rev = "bad5084e148ae1a392e3ac1ea96a6217f7f02844";
      fetchSubmodules = false;
      sha256 = "sha256-4Li2I69yUZ7/TYJbCkqV7YhFac325rvbbYEdC8ycyHM=";
    };
    date = "2024-12-14";
  };
  av1an = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "3cba4ba44e7ba3cc8bb67ac71bc61245b5aca347";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "3cba4ba44e7ba3cc8bb67ac71bc61245b5aca347";
      fetchSubmodules = true;
      sha256 = "sha256-2VFpN+qCJWAwn/awPBG8XT7ZY9dJsjDkg2zOLnXbSo4=";
    };
    date = "2024-12-13";
  };
  hyprwayland-scanner = {
  ...
  llamafile = {
    pname = "llamafile";
    version = "4158265e6baa627586d043da68d45849ba993604";
    src = fetchFromGitHub {
      owner = "Mozilla-Ocho";
      repo = "llamafile";
      rev = "4158265e6baa627586d043da68d45849ba993604";
      fetchSubmodules = false;
      sha256 = "sha256-l/0hH8j+BkSwitaUWXz3Mc3PnIWqjtzsjavk3gXtvEw=";
    };
    date = "2024-12-13";
  };
  mieru = {
    pname = "mieru";
    version = "558a92f2287a204beddeecc92f5f1d06f3ccd840";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "558a92f2287a204beddeecc92f5f1d06f3ccd840";
      fetchSubmodules = false;
      sha256 = "sha256-AJxu4B6S7456gJR36nVdQ8ZmAPtqU7reXtYojRsdJNU=";
    };
    date = "2024-12-13";
  };
  nbfc-linux = {
  ...
  swgp-go = {
    pname = "swgp-go";
    version = "7f93873d4f369e27056dde6a7afe0ba26286af4d";
    src = fetchFromGitHub {
      owner = "database64128";
      repo = "swgp-go";
      rev = "7f93873d4f369e27056dde6a7afe0ba26286af4d";
      fetchSubmodules = false;
      sha256 = "sha256-URzwl4pXteFbUWVYKG3NEsxudLtK7zjIWtQSDlkbMXg=";
    };
    date = "2024-12-13";
  };
  wayland = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "546c5d000d2696f423cd870780bf2378b6cc6a6b";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "546c5d000d2696f423cd870780bf2378b6cc6a6b";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-8FnsPoRpA6FJxwYnw9/m0vJzwcFiVtaDgSMxSlBBybg=";
    };
    date = "2024-12-11";
  };
}
