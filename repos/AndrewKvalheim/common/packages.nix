...
specify {
  ...
  git-remote = any;
  gnome-shell = { patch = ../packages/resources/gnome-shell_screenshot-location.patch; ccache = true; }; # Pending GNOME/gnome-shell#5370
  gnomeExtensions.launcher.patch = [ ../packages/resources/gnome-extension-launcher_icon.patch ../packages/resources/gnome-extension-launcher_hide-settings.patch ];
  gopass-await = any;
  gopass-env = any;
  gopass-ydotool = any;
  gpx-reduce = any;
  ...
  inkscape = { patch = ../packages/resources/inkscape_png-no-comment.patch; ccache = true; }; # Pending inkscape/inkscape!7193
